/* /skills — Skills list (Skills Lab). SkillCards + create/import. Selecting
   a skill navigates to the 5-tab detail view at /skills/:id. Mirrors
   AgentsListView's structure. */
"use client";
...
import { useSkills, useUpdateSkill, useSkillUsageCounts } from "@/lib/hooks/skills";
