 ...
 *
 * The sync logic itself lives in `pulls/service.ts` (shared with the pulls
 * list's own best-effort sync) so the two modules don't duplicate the
 * GitHub-PR-upsert block.
 */
