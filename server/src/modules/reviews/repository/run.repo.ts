 ...
 *  Workspace-scoped — matches `deleteAgentRun`'s tenancy guard above. */
...
/** Workspace-scoped: joins through `agent_runs` (run_traces has no workspace_id
 *  of its own) so a run trace can't be fetched across tenants by guessing an id. */
