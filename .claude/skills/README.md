...
| [backend-onion-architecture](backend-onion-architecture/SKILL.md) | Backend | Onion/hexagonal layering for `server/` + `reviewer-core/`: layer placement, dependency direction |
| [next-best-practices](next-best-practices/SKILL.md) | Frontend | Next.js App Router, RSC boundaries, data fetching, optimization |
| [react-best-practices](react-best-practices/SKILL.md) | Frontend | React anti-patterns, state management, hooks rules |
| [react-testing-library](react-testing-library/SKILL.md) | Frontend | General-purpose React Testing Library guide with Vitest |
| [frontend-ui-architecture](frontend-ui-architecture/SKILL.md) | Frontend | React/Next.js file placement, component splitting, hook/util/service boundaries |
